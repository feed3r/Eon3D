...
* Multiline comments should use standard C style (/*...*/); however,
...
* Every function should be preceded by a header in doxygen format
...
* Variables should be declared in a such a way they have the shortest scope
